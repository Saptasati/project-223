...
c=0
if not zipf:
    print('The zipped file/folder is not password protected')
else:
    starttime = time.time()
    ...
    for i in range(len(words)):
        ...
        c=c+1
        print('Trying to decode pasword by: {}'.format(word))
        try:
    ...
    if(result == 0):
        ...
        duration =  starttime
        print('Congratulations!!! Password found after trying '+str(c)+' combination in '+str(duration)+' seconds')
